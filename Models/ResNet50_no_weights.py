# Model Setup and Training for ResNet50 without pre-trained weights
...
# Load the ResNet50 model without pre-trained image weights
...
model.save('resnet50_no_weights.h5')
